...
import { deleteDuaCategory } from "../../../features/duaCategories/duaCategoriesSlice";

const DuaCategoriesTable = ({ data }) => {
  ...
  const handleDelete = () => {
    dispatch(deleteDuaCategory({ id: categoryId }));
  };
...
export default DuaCategoriesTable;
