...
import { deleteAzkarCategory } from "../../../features/azkarCategories/AzkarCategoriesSlice";
import { errorNotify } from "../../../util/getNotify";
import ConfirmationModal from "../../modals/ConfirmationModal";
import { Pagination } from "../../shared/pagination/Pagination";
import NoData from "../../shared/ui/NoData";

const AzkarCategoriesTable = ({ data }) => {
  ...
  const handleNavigate = (item) => {
    navigate("/azkar-categories-edit", {
      state: {
        payload: item,
        type: "edit",
      },
  ...
  const handleDelete = () => {
    dispatch(deleteAzkarCategory(categoryId))
      .unwrap()
      .then((res) => {
...
export default AzkarCategoriesTable;
