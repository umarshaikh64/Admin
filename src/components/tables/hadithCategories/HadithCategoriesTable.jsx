...
import { deleteCategory } from "../../../features/hadithCategories/hadithCategoriesSlice";
import { errorNotify } from "../../../util/getNotify";
import ConfirmationModal from "../../modals/ConfirmationModal";
import { Pagination } from "../../shared/pagination/Pagination";
import NoData from "../../shared/ui/NoData";

function HadithCategoriesTable({ data }) {
  ...
  const handleNavigate = (item) => {
    navigate("/hadith-categories-edit", {
      state: {
        payload: item,
        type: "edit",
      },
          ...
          {currentRows?.length === 0 ? (
            ...
            <tbody className="">
              {currentRows?.map((category, i) => (
                <tr className=" bg-white text-blackSemi" key={category?._id}>
                  ...
                  <td className="py-3 text-blackLowEmp text-base font-normal font-poppins">
                    {category?.categoryEnglish?.length > 20
                      ? category?.categoryEnglish?.slice(0, 20) + "..."
                  ...
                  <td className="py-3 text-blackLowEmp text-base font-normal font-poppins w-[200px] flex justify-center items-center">
                    ...
                    <label
                      ...
                      onClick={() => setSelectedItemId(category._id)}
                    >
                      <svg
                        width="24"
                        height="24"
...
export default HadithCategoriesTable;
